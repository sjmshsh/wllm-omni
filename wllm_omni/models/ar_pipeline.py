    ...
    def finalize(
        ...
        return ARTextOutput(
            ...
            metadata={
                ...
                "kv_cache_source": "transformers_past_key_values" if prefill.metadata.get("kv_cache_enabled", False) else None,
                "kv_cache_backend": prefill.metadata.get("kv_cache_type"),
                "runtime_kv_manager": False,
            },
        )
